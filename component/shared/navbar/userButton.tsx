...
export default function UserButton({
    ...
    return (
        <div className="relative inline-block text-left">
            <button
                type="button"
                className="inline-flex w-full items-center justify-center gap-x-1.5 rounded-full px-4 py-2 text-sm font-medium border dark:border-none transition-colors
